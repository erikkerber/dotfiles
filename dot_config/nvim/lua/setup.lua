...
vim.keymap.set('n', '<leader>cc', ':let @/=""<CR>', {silent = true, noremap = true})
...
vim.keymap.set('n', '<leader>x', '"_d', {noremap = true})
vim.keymap.set('v', '<leader>x', '"_d', {noremap = true})
...
vim.keymap.set('n', '<leader>l', '<cmd>lua vim.diagnostic.setloclist()<CR>', {silent = true})
-- Invoke code actions
